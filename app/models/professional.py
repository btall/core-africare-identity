...
class Professional(Base):
    ...
    first_name: Mapped[str] = mapped_column(
        String(100), nullable=False, comment="Prénom du professionnel"
    )
    last_name: Mapped[str] = mapped_column(
        String(100), nullable=False, comment="Nom de famille du professionnel"
    )
    title: Mapped[Literal["Dr", "Pr", "Inf", "Sage-femme", "Pharmacien", "Autre"]] = mapped_column(
        String(20), nullable=False, default="Dr", comment="Titre professionnel"
    )

    # Informations professionnelles
    specialty: Mapped[str] = mapped_column(
        String(100), nullable=False, comment="Spécialité médicale principale"
    )
    sub_specialty: Mapped[str | None] = mapped_column(
        String(100), nullable=True, comment="Sous-spécialité médicale"
    )
    professional_type: Mapped[
        Literal["physician", "nurse", "midwife", "pharmacist", "technician", "other"]
    ] = mapped_column(String(50), nullable=False, comment="Type de professionnel de santé")
    ...
    phone: Mapped[str] = mapped_column(
        String(20), nullable=False, comment="Téléphone professionnel au format E.164"
    )
    phone_secondary: Mapped[str | None] = mapped_column(
        String(20), nullable=True, comment="Téléphone secondaire"
    )

    # Établissement de rattachement
    facility_name: Mapped[str | None] = mapped_column(
        String(255), nullable=True, comment="Nom de l'établissement de santé"
    )
    facility_type: Mapped[
        Literal["hospital", "clinic", "health_post", "private_practice", "other"] | None
    ] = mapped_column(String(50), nullable=True, comment="Type d'établissement")
    facility_address: Mapped[str | None] = mapped_column(
        String(500), nullable=True, comment="Adresse de l'établissement"
    )
    facility_city: Mapped[str | None] = mapped_column(
        String(100), nullable=True, comment="Ville de l'établissement"
    )
    facility_region: Mapped[str | None] = mapped_column(
        String(100), nullable=True, comment="Région de l'établissement"
    )

    # Qualifications
    qualifications: Mapped[str | None] = mapped_column(
        Text, nullable=True, comment="Diplômes et qualifications (JSON ou texte libre)"
    )
    years_of_experience: Mapped[int | None] = mapped_column(
        nullable=True, comment="Années d'expérience professionnelle"
    )
    ...
    is_active: Mapped[bool] = mapped_column(
        nullable=False, default=True, index=True, comment="Professionnel actif dans le système"
    )
    is_verified: Mapped[bool] = mapped_column(
        nullable=False, default=False, comment="Informations professionnelles vérifiées"
    )
    ...
    notes: Mapped[str | None] = mapped_column(Text, nullable=True, comment="Notes administratives")
